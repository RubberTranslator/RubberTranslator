...
public class SystemConfigurationStaticProxy extends SystemConfiguration{
    ...
    public Boolean isTryFormat() {
        return configuration.isTryFormat();
    }
    ...
    public void setTryFormat(Boolean tryFormat) {
        configuration.setTryFormat(tryFormat);
        SystemResourceManager.getFacade().getTextPreProcessor().setTryToFormat(tryFormat);
    }
    ...
    public Point getLastPos() {
        return configuration.getLastPos();
    }

    @Override
    public void setLastPos(Point lastPos) {
        configuration.setLastPos(lastPos);
    }

    @Override
    public Point getLastSize() {
        return configuration.getLastSize();
    }

    @Override
    public void setLastSize(Point lastSize) {
        configuration.setLastSize(lastSize);
    }

    @Override
    public String getLastFxmlPath() {
        return configuration.getLastFxmlPath();
    }

    @Override
    public void setLastFxmlPath(String lastFxmlPath) {
        configuration.setLastFxmlPath(lastFxmlPath);
    }

    @Override
    public Boolean isAutoHide() {
        return configuration.isAutoHide();
    }
